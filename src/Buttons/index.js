...
const Buttons = ({ tasks, hideDone, toggleHide, setAllDone, removeAllTasks }) => (
    tasks.length > 0 && (
        <>
            ...
            <button onClick={removeAllTasks} className="button button--removeAllButton">remove all tasks</button>
        </>
    )
)
